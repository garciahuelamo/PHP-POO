<?php
    ...
    En un carrito - podemos almacenar los productos o bien sueltos o bien en arrays -> aun que no es un buen
    consejo. Lo haríamos mejor si creamos un clase que fuese "carrito"
    */
?>